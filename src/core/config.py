...
class ServiceSettings:
    ...
    policy_version: str = os.getenv("POLICY_VERSION", "targeted-support-policy-v2")
    feature_schema_version: str = os.getenv("FEATURE_SCHEMA_VERSION", "financial_customer_features_v3")
